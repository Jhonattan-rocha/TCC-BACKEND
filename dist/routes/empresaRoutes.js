...
router.post('/empresa/', _validateCPFCNPJ2.default, _EmpresaController2.default.store);
router.get("/empresas/", _loginriquired2.default, _getAtributes2.default, _filter2.default, _EmpresaController2.default.index);
router.get("/empresa/:id", _loginriquired2.default, _getAtributes2.default, _EmpresaController2.default.show);
router.put('/empresa/:id', _loginriquired2.default, _getAtributes2.default, _EmpresaController2.default.update);
router.delete('/empresa/:id', _loginriquired2.default, _getAtributes2.default, _EmpresaController2.default.delete);
