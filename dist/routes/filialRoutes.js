...
router.post('/filiais/', _loginriquired2.default, _validateCPFCNPJ2.default, _FilialsController2.default.store);
router.get("/filial/", _loginriquired2.default, _getAtributes2.default, _filter2.default, _FilialsController2.default.index);
router.get("/filial/:id", _loginriquired2.default, _getAtributes2.default, _FilialsController2.default.show);
router.put('/filial/:id', _loginriquired2.default, _getAtributes2.default, _FilialsController2.default.update);
router.delete('/filial/:id', _loginriquired2.default, _getAtributes2.default, _FilialsController2.default.delete);
